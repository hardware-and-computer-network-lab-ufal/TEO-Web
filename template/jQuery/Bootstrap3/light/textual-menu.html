                ...
                <li class="pull-right">
                    <ul class="hi-menu">
                        ...
                        <li data-ma-action="search-open">
                            <a href=""><span class="him-label">Search</span></a>
                        </li>

                        <li class="dropdown">
                            <a data-toggle="dropdown" href="">
                                <span class="him-label">Messages</span>
                            </a>
                        ...
                        <li class="dropdown hidden-xs">
                            <a data-toggle="dropdown" href="">
                                <span class="him-label">Notifications</span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-lg pull-right">
                        ...
                        <li class="dropdown hidden-xs">
                            <a data-toggle="dropdown" href=""><span class="him-label">Settings</span></a>
            ...
            <aside id="sidebar" class="sidebar c-overflow">
                ...
                <ul class="main-menu">
                    ...
                    <li class="sub-menu toggled active">
                        ...
                        <ul>
                            <li><a class="active" href="textual-menu.html">Textual menu</a></li>
